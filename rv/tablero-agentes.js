...
Borde.prototype = new THREE.Geometry();
...
var cF = new casilla.prototype.Casilla();
casilla.prototype.casillaB = new Array();
for(var i=1; i<=32; i++){
casilla.prototype.casillaB[i] = new THREE.Mesh(cF,material);
}
var  b=1;
 for(var f=1; f<=8; f++)
{
  for(var c=1; c<=8; c++)
  {
    if(f%2==0)
    {
      ...
      {
       casilla.prototype.casillaB[b].position.set((f*10),(c*10),0);
       .escena.add(AJEDREZ.casillaB[b]);
