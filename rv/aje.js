...
ReinaGeometry=function()
{
  ...
  CuerpoReina1.translate(0,1.05,0);
...
Agent.prototype.operations.goStraightX=function(pieza,distance)
{
  ...
  b=pieza.piernad.rotation.x*Math.pow(10, 1);
  b=Math.round(b);
  b= b/Math.pow(10,1);
  if(b===0.3)
    a=-0.05;
    ...
    a=0.05;
  pieza.piernad.rotation.x+=a;
  pieza.piernai.rotation.x+=-a;
  /*c=pieza.brazod.rotation.z*Math.pow(10, 1);
  c=Math.round(c);
  c= c/Math.pow(10,1);
  if(c===0.3)
    d=-0.05;
    ...
    d=0.05;
  pieza.brazod.rotation.z+=d;
  pieza.brazoi.rotation.z+=d;*/
};
...
function Caballo(sTP,x,y)
{
  ...
  this.brazod=new THREE.Mesh(new THREE.BoxGeometry(1,6,1),new THREE.MeshLambertMaterial({map:textura}));
  this.piernai.position.set(-1.8,0,-3.1);
  this.piernad.position.set(1.8,0,-3.1);
  this.brazod.position.set(0.4,1.4,4);
  this.brazoi.position.set(0.4,-1.4,4);
  this.add(/*this.brazoi,this.brazod,*/this.piernai,this.piernad,this.actuator);
...
function Alfil(sTP,x,y)
{
  ...
  this.brazod=new THREE.Mesh(new THREE.BoxGeometry(5,1,1),new THREE.MeshLambertMaterial({map:textura}));
  this.piernai.position.set(-1.8,0,-3.1);
  this.piernad.position.set(1.8,0,-3.1);
  this.brazod.position.set(2.5,0,4);
  this.brazoi.position.set(-2.5,0,4);
  this.add(/*this.brazoi,this.brazod,*/this.piernai,this.piernad,this.actuator);
  this.actuator.scale.set(9.5,9.5,9.5);
  this.actuator.rotateX(Math.PI/2);
  this.actuator.castShadow=true;
    ...
    if ( Math.sqrt(Math.pow(X-x,2)+Math.pow(Y-y,2))<=(obstaculo[0].distance+10*Math.sqrt(2)) ){
      ...
      if (obstaculo[0].distance<=Math.sqrt(2))
        if (this.sTP === true){
          ...
          obstaculo[0].object.parent.piernad.translate(50+bi,-50+bj,0);
          obstaculo[0].object.parent.piernai.translate(50+bi,-50+bj,0);
          //bi++;
          bj+=10;
        }
      else{
...
function Reina(sTP,x,y)
{
  ...
  this.brazod=new THREE.Mesh(new THREE.BoxGeometry(6,1,1),new THREE.MeshLambertMaterial({map:textura}));
  this.piernai.position.set(-1.8,0,-3.1);
  this.piernad.position.set(1.8,0,-3.1);
  this.brazod.position.set(1.8,0,4);
  this.brazoi.position.set(-1.8,0,4);
  this.add(/*this.brazoi,this.brazod,*/this.piernai,this.piernad,this.actuator);
  this.actuator.scale.set(9.5,9.5,9.5);
  this.actuator.rotateX(Math.PI/2);
}
